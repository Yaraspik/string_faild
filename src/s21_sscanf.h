...
#if defined(VERBOSE_MADE) && defined(DEBUG)
...
typedef struct token {
  void *addr;  // Адрес соответствующего указателя vararg
...
//(1) Этап синтаксического анализа токенов (правил)
